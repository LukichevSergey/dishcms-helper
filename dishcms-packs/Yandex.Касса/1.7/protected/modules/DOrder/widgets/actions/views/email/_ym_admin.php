...
<?php foreach($model->getCustomerData() as $name=>$data): 
	if(in_array($name, array('orderNumber', 'shopSuccessURL', 'shopFailURL', 'scid', 'Sum', 'ShopID', 'CustomerNumber'))) continue; 
	    ...
	    <li>
	    	...
	    	<ul style="list-style: none">
	    		...
	    		<?php foreach($outAttributes as $attribute=>$data): ?>
	    			<?php if($data['value'] && !in_array($attribute, array('id', 'model', 'title', 'categoryId'))): ?>
	    			<li>
