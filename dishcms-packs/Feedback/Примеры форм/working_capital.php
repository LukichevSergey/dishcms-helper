 ...
 * ОНЛАЙН Заявка
 *
 * Кредит без залога на пополнение оборотных средств
 *
 * 1.Имя
...
return array(
	'working_capital' => array(
		'title' => 'Онлайн-заявка: Кредит без залога на пополнение оборотных средств',
		'short_title' => 'Кредит без залога на пополнение оборотных средств',
		// Options
		'options' => array(
			'useCaptcha' => false,
			'sendMail' => true,
