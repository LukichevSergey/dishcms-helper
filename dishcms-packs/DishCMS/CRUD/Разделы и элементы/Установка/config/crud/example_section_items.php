<?php
$c=[
    'class'=>'\crud\models\ar\',
    'tablename'=>'crud_sections_items_',
	'crud_parent'=>'',
	'crud_parent_class'=>'\crud\models\ar\',
	'public_url_view'=>'//view',
    'l'=>[
		'config.section_id'=>'Раздел',
		'config.preview_text'=>'Анонс',
	    'buttons.create'=>'Добавить',
    	'crud.index.title'=>'Список',
	    'crud.create.title'=>'Новый',
