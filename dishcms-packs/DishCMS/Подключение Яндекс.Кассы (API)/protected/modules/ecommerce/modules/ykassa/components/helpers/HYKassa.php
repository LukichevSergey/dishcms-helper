...
class HYKassa
{
    ...
    public static function isHttpMode()
    {
        return (static::settings()->mode == self::MODE_HTTP);
    }
    public static function isHttpTestMode()
    {
        return (static::settings()->mode == self::MODE_HTTP_TEST);
    }
