...
abstract class YmlGenerator extends CApplicationComponent {
    ...
    /**
    * Xml file not included categories
    * @var string
    */
    public $categoriesNotIDs = array();

    /**
     * Xml file not include notexist offers
     * @var string
     */
    public $notexist;
    ...
    public $offerElements = array('url', 'price', 'currencyId', 'categoryId', 'market_category', 
            ...
            'seller_warranty','country_of_origin', 'downloadable', 'age','barcode','cpa', 'oldprice',
    ...
    protected function beforeWrite() {
        ...
        $engine->startDTD('yml_catalog SYSTEM "shops.dtd"'); 
        $engine->endDTD();
