<?php
namespace ecommerce\modules\moysklad\modules\admin\components\base;
...
class Controller extends \AdminController
{
     ...
     */
    public $viewPathPrefix='ecommerce.modules.moysklad.modules.admin.views.';
    ...
    {
        Y::module('ecommerce.moysklad.admin');
