...
class CdekBehavior extends \CBehavior
{
    ...
    {
        if(!$this->isCdekDeliveryType() || ($this->owner->scenario!='create')) {
            return true;
        }
    ...
    public function afterSave()
    {
        ...
        if($cdek->isNewRecord && $this->isCdekDeliveryType()) {
            ...
            $this->owner->cdek->rec_phone=HCdek::normalizePhone(A::rget($customer, 'phone.value'));
            ...
            foreach($orderItems as $item) {
                $weight=A::rget($item, $this->attributeProductWeight.'.value', 0) * 1000;
