<?php
namespace ecommerce\modules\robokassa\modules\admin\components\base;
...
class Controller extends \AdminController
{
     ...
     */
    public $viewPathPrefix='ecommerce.modules.robokassa.modules.admin.views.';
    ...
    {
        Y::module('ecommerce.robokassa.admin');
