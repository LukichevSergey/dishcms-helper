 ...
 *
 */
namespace extend\modules\buildings\modules\admin\components;
...
abstract class BaseController extends \AdminController
{
	 ...
	 */
	public $viewPathPrefix='extend.modules.buildings.modules.admin.views.';
	...
	{
		Y::module('extend.buildings')->getModule('admin');
