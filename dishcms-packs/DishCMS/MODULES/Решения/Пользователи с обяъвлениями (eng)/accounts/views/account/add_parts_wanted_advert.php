...
?>
    <div class="account-main account-wanted">
    	...
    	<div class="accounts__flash-fail">You are not authorized to add ads.</div>
    </div>
<?php 
else: 
?>
<div class="account-main account-wanted">
	...
	<div class="form-advert">
		<?php $this->beginWidget('\common\widgets\form\ActiveForm', [
    	    'id'=>'accounts__add-wanted-parts-advert-form',
		    'model'=>$advert,
    	    ...
    	    'formOptions'=>[
    	        ...
    	        'clientOptions'=>[
    	            ...
    	            'validationUrl'=>'/accounts/account/addSaleAdvert',
    	        ],
    	    ...
    	    'submitLabel'=>function() {
    	        ?>
    	        	<button type="submit" class="btn">Post Advert</button>
				</div>
    	        <?php 
    	    },
    	]); ?>
