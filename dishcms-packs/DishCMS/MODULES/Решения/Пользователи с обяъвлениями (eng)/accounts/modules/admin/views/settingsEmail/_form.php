...
<div class="form js-settings-tabs" style="display: none">
    <div class="panel panel-default">
    	<div class="panel-body" style="padding-bottom:0;">
    		<input type="number" min="0" class="js-accounts-settings-email-account-id form-control inline" style="width:13%" placeholder="Account ID">
    		<input type="number" min="0" class="js-accounts-settings-email-advert-id form-control inline" style="width:12%" placeholder="Advert ID">
