 ...
 * @since 1.0
 */
class CaptchaNumberAction extends CAction
{
	/**
	...
	protected function renderImageGD($code)
	{
		...
		if($this->fontFile === null)
			$this->fontFile = dirname(__FILE__).DIRECTORY_SEPARATOR.'IkraSlab.ttf';//SpicyRice.ttf';
	...
	protected function renderImageImagick($code)
	{
		...
		if($this->fontFile===null)
			$this->fontFile=dirname(__FILE__).DIRECTORY_SEPARATOR.'IkraSlab.ttf';
