...
$this->widget('zii.widgets.CListView', [
    'dataProvider'=>(new \CArrayDataProvider($images, ['pagination'=>['pageSize'=>120]])),
    'itemView'=>'_images_item',
    'viewData'=>['imagesBaseUrl'=>$this->imagesUrl],
    'pagerCssClass'=>'pagination',
    // 'summaryText'=>'<small>изображения c {start} по {end} из {count}<small>',
