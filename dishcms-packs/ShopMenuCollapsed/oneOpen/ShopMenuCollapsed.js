...
$(document).ready(function() {
	...
	// закрывать меню, если прямой переход по странице
	$('ul.shop-menu > li > a').on('click', function(e) {
		ShopMenuCollapsed.close($('ul.shop-menu .expanded'), true);
		$.cookie(ShopMenuCollapsed.cookieVarName, null, {expires:null, path:'/'});
	});
});