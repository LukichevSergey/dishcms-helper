<? 
/**
 * Èìïîðò êàòàëîãà èç xml-ôàéëîâ CML2.0 áåç ïðÿìîãî îáìåíà ñ 1Ñ 8.1
...
function start(file) 
      ...
      load.innerHTML="<b>Çàãðóçêà</b>...<img align='center'                 src='http://gifanimation.ru/images/ludi/17_3.gif' width='30'/>" 
             i=1; 
      a=""; 
      m_second=0; 
        seconds=0; 
      ...
      log.innerHTML="<b>Èìïîðò "+file+"</b><hr>"; 
      query_1c(file) 
      }
      ...
      import_1c.onreadystatechange = function() 
            ...
            if (import_1c.readyState == 4 && import_1c.status == 0) 
                  { 
                  error_text="<em>Îøèáêà â ïðîöåññå âûãðóçêè</em><div style='width:270;font-size:11;border:1px solid             black;background-color:#ADC3D5;padding:5'>Ñåðâåð óïàë è íå âåðíóë çàãîëîâêîâ.</div>" 
                     log.innerHTML=a+"Øàã "+i+": "+error_text; 
                  ...
                  if (import_1c.readyState == 4 && import_1c.status == 200)   
                     { 
                        ...
                        { 
                           error_text="<em>Îøèáêà â ïðîöåññå âûãðóçêè</em><div style='width:270;font-size:11;border:1px solid black;background-color:#ADC3D5;padding:5'>"+import_1c.responseText+"</div>" 
                           log.innerHTML=a+"Øàã "+i+": "+error_text; 
                           status="error"; 
                        } 
                        else 
                        { 
                           ...
                           log.innerHTML=a+"Øàã "+i+": "+mess+" ("+seconds+" ñåê.)"+"<br>"; 
                           seconds=0; 
                           load.style.display="none"; 
                           i++; 
                        } 
                        ...
                        { 
                           ...
                           status="continue" 
                           proccess=false; 
                           timer.innerHTML="<hr>Âðåìÿ âûãðóçêè: <b>"+minute+" ìèí. "+m_second+" ñåê.</b>"; 
                        } 
                        else 
                        { 
                           query_1c(file); 
