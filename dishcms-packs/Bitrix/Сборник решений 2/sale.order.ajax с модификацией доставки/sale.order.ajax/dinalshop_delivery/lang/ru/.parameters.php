<?
$MESS["ORDER_AJAX_EXT_DELIVERY_GROUP_ID"] = "Идентификатор группы свойств для доставки (физ. лицо)";
$MESS["ORDER_AJAX_EXT_BIZ_DELIVERY_GROUP_ID"] = "Идентификатор группы свойств для доставки (юр. лицо)";
$MESS["ORDER_AJAX_EXT_PICKUP_DELIVERY_ID"] = "Идентификатор доставки (Самовывоз)";
$MESS["ORDER_AJAX_EXT_NSK_DELIVERY_ID"] = "Идентификатор доставки (до Новосибирска)";
$MESS["ORDER_AJAX_EXT_OTHER_DELIVERY_ID"] = "Идентификатор доставки (в другие города)";
$MESS["ORDER_AJAX_EXT_NSK_DISTRICTS_IBLOCK_ID"] = "Идентификатор инфоблока районов г. Новосибирска";
