...
$arTemplateParameters = array(
	"ORDER_AJAX_EXT_DELIVERY_GROUP_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_DELIVERY_GROUP_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
	),
	"ORDER_AJAX_EXT_BIZ_DELIVERY_GROUP_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_BIZ_DELIVERY_GROUP_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
	),
	"ORDER_AJAX_EXT_PICKUP_DELIVERY_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_PICKUP_DELIVERY_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
	),
	"ORDER_AJAX_EXT_NSK_DELIVERY_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_NSK_DELIVERY_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
	),
	"ORDER_AJAX_EXT_OTHER_DELIVERY_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_OTHER_DELIVERY_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
	),
	"ORDER_AJAX_EXT_NSK_DISTRICTS_IBLOCK_ID" => array(
		"NAME" => GetMessage("ORDER_AJAX_EXT_NSK_DISTRICTS_IBLOCK_ID"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "",
		"PARENT" => "BASE",
