...
class CIBlockCMLImportCustom
{
	...
	/** @var CIBlockXMLFileCustom $_xml_file */
	var $_xml_file = null;
	...
	function initMess($return=false)
	{
	    ...
	    $this->mess = __IncludeLang(dirname(__FILE__).'/../../lang/ru/cml2_utf8.php', true);
	...
	function Init(&$next_step, $files_dir = false, $use_crc = true, $preview = false, $detail = false, $use_offers = false, $use_iblock_type_id = false, $table_name = "b_xml_tree")
	{
		...
		$this->_xml_file = new CIBlockXMLFileCustom($table_name);
