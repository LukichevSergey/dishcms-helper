...
class Cache extends \Bitrix\Main\Data\Cache
{
     ...
     * @return mixed
     */
    public static function get($cacheTime, $cacheId, $cacheDir='/', $hGetResults=null, $parameters=[])
    {
     ...
     * Очистка кэша
     */
    public static function clear($cacheId, $cacheDir='/') 
    {
        return \CPHPCache::Clean($cacheId, $cacheDir);
    }
}
