jQuery(document).ready(function(){
    ...
    window.konturRegionsChangeCity=(function(options){
        ...
        _this.onHoverRegion=function(e) {
            var $region=$(e.target).closest(s('region'));
			var q='[data-item='+$region.data('item')+']';
			j('cities:not('+q+')').hide();
            j('cities'+q).show();
        };
        ...
        _this.onHoverCity=function(e) {
			...
			var $cities=$city.parents(s('cities:first'));
			...
			j('cities').removeClass('active');
			j('region[data-item=' + $cities.data('item') + ']').addClass('active');
