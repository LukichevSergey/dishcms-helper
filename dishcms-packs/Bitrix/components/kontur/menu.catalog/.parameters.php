...
$arComponentParameters = array(
	"GROUPS" => array(
		"STATIC_LINKS" => array(
			"NAME" => GetMessage("COMP_GROUP_STATIC_LINKS"),
            "SORT" => 100
		),
	...
	"PARAMETERS" => array(
		...
		"STATIC_LINK_NEWEST" => array(
         	"PARENT" => "STATIC_LINKS",
         	"NAME" => GetMessage("COMP_PROP_LINK_NEWEST"),
         	"TYPE" => "STRING",
      	),
	    "STATIC_LINK_SALE" => array(
            "PARENT" => "STATIC_LINKS",
            "NAME" => GetMessage("COMP_PROP_LINK_SALE"),
            "TYPE" => "STRING",
        ),
