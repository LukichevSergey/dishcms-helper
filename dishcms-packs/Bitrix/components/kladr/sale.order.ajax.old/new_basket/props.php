...
?>
<div class="section bx-old-soa-profile">
...
<br/>
<div class="bx_section bx-old-soa-buyer">
	<h4>
...
<?if(!CSaleLocation::isLocationProEnabled()):?>
	<div style="display:none;">
		...
		<?$APPLICATION->IncludeComponent(
			"kontur:sale.ajax.locations",
			'new_basket_locations',
			array(
				"AJAX_CALL" => "N",
				...
				//"REGION"=>"0000028095" // Новосибирская область - 6
