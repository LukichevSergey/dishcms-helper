			...
			<tbody>
				...
				<tr>
					...
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arColumn):
						...
						if (in_array($arColumn["id"], array("DISCOUNT_PRICE_PERCENT_FORMATED"))) {
							continue;
						}
		...
		<div class="bx_ordercart_order_pay_right">
			<table class="bx_ordercart_order_sum">
				<tbody>
					...
					<tr>
                        <td class="total_title" rowspan="3"><?=GetMessage("SOA_TEMPL_TOTAL")?></td>
					...
					if (doubleval($arResult["DELIVERY_PRICE"]) > 0)
					{
						...
						<?if($arResult["DELIVERY"][(int)$arParams['DELIVERY_OUTNSK_ID']]["CHECKED"] =="Y"){?>
							<tr>
								<td class="custom_t1" colspan="<?=$colspan?>" class="itog"><?=GetMessage("SOA_TEMPL_SUM_DELIVERY")?></td>
								<td class="custom_t2" class="price"><?=GetMessage("SOA_TEMPL_DELIVERY_FREE_OUT")?></td>
							</tr>
						<?}elseif($arResult["DELIVERY"][(int)$arParams['DELIVERY_SELFPICKUP_ID']]["CHECKED"] =="Y"){?>
							<tr>
								<td class="custom_t1" colspan="<?=$colspan?>" class="itog"><?=GetMessage("SOA_TEMPL_SUM_DELIVERY_12")?></td>
								<td class="custom_t2" class="price"><?=GetMessage("SOA_TEMPL_DELIVERY_FREE")?></td>
							</tr>
			...
			<div class="bx_ordercart_order_pay_center" style="width: 60%">
				<a href="/personal/cart/#basket" id="ORDER_MODIFY_BUTTON" class="checkout">Изменить заказ</a>
