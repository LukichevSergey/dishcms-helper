...
if(!empty($PROP)):
	...
	$GLOBALS['KONTUR_CALC_FORM_FIELDS_PROP_FIELDS']=[];
	$GLOBALS['KONTUR_CALC_FORMULAS_PROP_FIELDS']=[];
	foreach($PROP as $prop_code=>$prop_fields):
        ...
        if($prop_fields['ID'] == $calcPropFormFieldsId) {
			$GLOBALS['KONTUR_CALC_FORM_FIELDS_PROP_FIELDS']=$prop_fields;
            include dirname(__FILE__) . '/calc_item_iblock_element_edit_custom_field_form_fields.php';
        }
        elseif($prop_fields['ID'] == $calcPropCalcFormulasId) {
			$GLOBALS['KONTUR_CALC_FORMULAS_PROP_FIELDS']=$prop_fields;
            include dirname(__FILE__) . '/calc_item_iblock_element_edit_custom_field_calc_formulas.php';
        }
        else {
		?>
