...
<div id="content">
    ...
    <div class="form-no" class="js-payment-form-wrapper">
        ...
        <form action="" method="post" class="disclaimer__form js-disclaimer-form">
            <div class="form-no-inputs">
                ...
                <div class="form-no-row">
                    ...
                    <div class="form-no-col">
                        <div class="form-no-input">
							<p style="position:absolute;top:-30px;color:#535c69;right:15px;">на данную почту Вам придет уведомление</p>
                ...
                <div class="form-no-row js-creditor-block" data-id="0">
                	<div class="form-no-col">
                        <div class="form-no-input">
                            <input type="text" name="creditor_name" placeholder="Наименование Кредитора или ИНН">
                        </div>
                    </div>
                    <div class="form-no-col">
                       <div class="form-no-input">
                    ...
                    <div class="form-no-col js-creditor-city" style="display:none">
                        <div class="form-no-input">
                            <input type="text" name="creditor_city" placeholder="Город и улица">
                        </div>
                    </div>
                    <div class="form-no-col js-creditor-city-hint" style="display:none">
                        <div class="form-no-input">
                            <p style="color:#535c69;">Если адреса организации <span class="js-creditor-city-hint-text"></span> нет в списке, уточните, пожалуйста, город и улицу</p>
                        </div>
                    </div>
                    <div class="form-no-col">
                        <div class="form-no-input">
                    ...
                    <div class="form-no-col">
                       <div class="form-no-input js-creditor-address">
                ...
                <div class="form-no-row">
                    ...
                    <div class="form-no-col form-no-col_100">
                        <div class="form-no-checkbox">
                            ...
                            <label for="agree">Подтверждаю свое согласие с <a href="#politika" class="open_window">Политикой обработки данных</a></label>
                        </div>
                    </div>
                </div>
