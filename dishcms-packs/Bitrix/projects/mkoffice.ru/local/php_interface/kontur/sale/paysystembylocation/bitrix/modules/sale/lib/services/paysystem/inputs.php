...
namespace Bitrix\Sale\Paysystem\Inputs;
...
class LocationMulti extends Input\Base
{
	...
	public static function getEditHtml($name, array $input, $values = null)
	{
		...
		$APPLICATION->IncludeComponent(
			...
			"",
			array(
				"ENTITY_PRIMARY" => $input["PAYSYSTEM_ID"],
				"LINK_ENTITY_NAME" => PaySystem\Manager::getLocationConnectorEntityName(),
				"INPUT_NAME" => $name
			),
			false
		);
...
Input\Manager::register('PAYSYSTEM_LOCATION_MULTI', array(
	'CLASS' => __NAMESPACE__.'\\LocationMulti',
	'NAME' => Loc::getMessage('INPUT_paysystem_LOCATION_MULTI')
));
