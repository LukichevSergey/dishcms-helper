<?php
namespace Bitrix\Sale\Services\PaySystem;
...
class Manager
{
	...
	{
	    return Internals\PaySystemTable::getList($parameters);
	}
	...
	{
		return Internals\PaySystemTable::getById($id);
	}
	...
	{
		return	'Bitrix\Sale\Internals\PaySystemLocation';
	}
	...
	public static function getUserCompanyList($id)
	{
		...
		if (empty($list[$id]))
		{
			...
			$resCompany = Internals\PaySystemTable::getList($filterCompany);
